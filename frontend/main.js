/**
 * AI Exam Helper - Electron Application Entry Point
 * NPU-Accelerated Accessibility Assistant with AnythingLLM
...
class AIExamHelperApp {
    ...
    setupMenu() {
        ...
        const template = [
            {
                label: 'AI Exam Helper',
                submenu: [
                    {
                        label: 'About AI Exam Helper',
                        click: () => {
                            dialog.showMessageBox(this.mainWindow, {
                                type: 'info',
                                title: 'About AI Exam Helper',
                                message: 'AI Exam Helper - Accessibility Assistant',
                                detail: 'NPU-accelerated exam assistance for students with reading difficulties\nPowered by AnythingLLM and Snapdragon NPU\n\n🏆 Hackathon Winner 2024!'
                            });
                        }
                    },
                    { type: 'separator' },
    ...
    async startBackend() {
        try {
            console.log('Starting AI Exam Helper backend...');
...
// Create app instance
const aiExamHelperApp = new AIExamHelperApp();

// App event handlers
app.whenReady().then(() => {
    aiExamHelperApp.initialize();
});
